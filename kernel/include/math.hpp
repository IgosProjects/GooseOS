...
namespace GooseOS::Math {
    // Clamps the provided value(val) to mvalue, if higher it will be set to mvalue if lower, it will not be touched
    u64 Clamp(u64 min, u64 max, u64 val);
}